...
export default function Home({ initialTarget }: { initialTarget?: string }) {
  ...
  return <main>
    <header className="siteHeader"><div className="nav wrap"><a className="brand" href="#top" aria-label="業務仕組みナビ ホーム"><span className="brandMark" aria-hidden="true">AI</span><span>業務仕組みナビ<small>AI業務改善・概算相談</small></span></a><nav aria-label="ページ内メニュー"><a href="#benefits">相談でわかること</a><a href="#challenge">課題</a><a href="#solution">解決方法</a><a href="#flow">進め方</a><a href="#comparison">他との違い</a><a href="#faq">よくある質問</a><a className="navCta" href="#contact">無料で相談する <b>→</b></a></nav></div></header>

    <section className="hero" id="top"><div className="heroGlow" /><div className="wrap heroGrid"><div className="heroCopy"><p className="eyebrow">{segment.area} × {segment.industry}の業務改善</p><h1>困っている仕事を話すだけ。<br />次に仕組み化すべき仕事が見えてくる。</h1><p className="lead">AIと人が、最初に整える業務・費用の目安・画面イメージまで無料で整理します。</p><div className="trust"><span>相談無料</span><span>入力は約3分</span><span>しつこい営業なし</span></div><p className="micro">何を作るか決まっていなくても、相談できます。</p></div><div className="googleEmbed" id="contact"><iframe title="無料相談フォーム" src={GOOGLE_FORM_EMBED_URL} loading="lazy" scrolling="yes" frameBorder="0">読み込んでいます…</iframe></div></div></section>

    <section className="benefits" id="benefits"><div className="wrap"><p className="eyebrow dark">無料相談で整理できること</p><h2>無料相談で、<em>業務・優先順位・費用の目安</em>を整理します。</h2><div className="benefitGrid"><article><span>01</span><h3>業務の詰まりどころ</h3><p>時間がかかる作業や、特定の人に判断が集中している場面を整理します。</p></article><article><span>02</span><h3>最初に整える業務</h3><p>すべてを変えるのではなく、効果が出やすい一歩目を一緒に考えます。</p></article><article><span>03</span><h3>おおよその費用</h3><p>内容に応じて、無理なく始める場合の概算費用を幅をもってお伝えします。</p></article></div></div></section>
    ...
    <section className="flow section" id="flow"><div className="wrap"><p className="eyebrow">ご相談から提案までの流れ</p><h2>答えるだけで、解決のかたちが見えてくる。</h2><div className="steps timeline"><article><span>STEP 01</span><div className="stepIcon" aria-label="相談する">話</div><h3>困りごとを教える</h3><p>業種や人数、いまの作業を選択式で回答。まとまった仕様書は不要です。</p></article><div className="flowArrow" aria-hidden="true"><i />→</div><article><span>STEP 02</span><div className="stepIcon" aria-label="整理する">整</div><h3>AIと人が整理する</h3><p>業務の流れを確認し、AIでできること・人が担うことを整理します。</p></article><div className="flowArrow" aria-hidden="true"><i />→</div><article><span>STEP 03</span><div className="stepIcon" aria-label="提案を受け取る">案</div><h3>概算と画面案を受け取る</h3><p>初期費用の目安と、完成後の画面イメージをご提案します。</p></article></div></div></section>

    <section className="comparison section" id="comparison"><div className="wrap"><p className="eyebrow dark">他の選択肢との違い</p><h2>仕様が決まっていなくても、<em>相談は始められます。</em></h2><p className="sectionLead">見積もりSaaS・AI開発・簡易見積もりは、必要な条件や作りたいものがある程度決まった後に使いやすい選択肢です。私たちは「何から変えるべきか分からない」段階から、業務の話を聞いて整理します。</p><div className="landscapeFlow"><article><span>見積もりSaaS</span><h3>必要な機能や条件が、すでに決まっている。</h3><p><b>向いている場面</b>仕様を入力して、工数や費用を算出したい。</p><small>何を仕組みにするかの整理は、別途必要です。</small></article><article><span>AI開発サービス</span><h3>作りたいものが、すでに見えている。</h3><p><b>向いている場面</b>要件を伝えて、開発を進めたい。</p><small>現場の困りごとを聞いて、最初の一歩を決める支援は別途必要です。</small></article><article><span>簡易見積もりLP</span><h3>入力する条件が、すでに決まっている。</h3><p><b>向いている場面</b>フォーム入力で、概算だけを早く知りたい。</p><small>入力項目にない困りごとや、業務の整理には向きません。</small></article></div><div className="comparisonBridge"><span>まだ何を作るか決まっていないなら</span><strong>まずは、困っている業務の話から。</strong><i aria-hidden="true">↓</i></div><div className="gapStatement"><div className="gapCopy"><span>業務仕組みナビなら</span><strong>話してみる。<em>次にやること</em>が見えてくる。</strong></div><ul className="gapJourney"><li><i>話</i><div><b>困りごとを話す</b><p>仕様書がなくても大丈夫です。</p></div></li><li><i>整</i><div><b>業務を整理する</b><p>必要なことを、分かりやすくまとめます。</p></div></li><li><i>決</i><div><b>進め方を決める</b><p>費用の目安と、最初の一歩を確認します。</p></div></li></ul><a className="gapCta" href="#contact">無料で困りごとを相談する <b>→</b></a></div><p className="comparisonNote">※ 一般的な提供形態をもとにした整理です。各サービスの内容は変更される場合があります。</p></div></section>
    ...
    <section className="bottomCta"><div className="wrap"><p>課題がまとまっていなくても、大丈夫です。</p><h2>{segment.pain}を、一度整理してみませんか。</h2><a href="#contact">無料相談を申し込む <b>→</b></a><small>入力は約3分・相談だけでもOK</small></div></section>
    {!floatDismissed && <aside className={`yFloat ${floatVisible ? "isVisible" : ""} ${floatPulse ? "isPulse" : ""}`} aria-label="無料相談へのご案内"><a className="floatLink floatContact" href="#contact"><small>入力は約3分・相談無料</small><strong>無料相談を申し込む <b>→</b></strong></a><button className="floatClose" type="button" aria-label="バナーを閉じる" onClick={() => { setFloatVisible(false); setFloatDismissed(true); sessionStorage.setItem("ai-estimate:float-dismissed", "1"); }}>✕</button></aside>}
    <footer><div className="wrap footerInner"><div><a className="brand" href="#top">業務仕組みナビ <small>AI業務改善・概算相談</small></a><p>地域企業のための、伴走型AI業務改善</p></div><nav className="footerLinks" aria-label="フッターメニュー"><a href="#benefits">相談でわかること</a><a href="#challenge">課題</a><a href="#solution">解決方法</a><a href="#flow">進め方</a><a href="#comparison">他との違い</a><a href="#consultation">ご相談の進め方</a><a href="#faq">よくある質問</a><a href="#contact">無料相談</a></nav></div></footer>
  </main>;
}
