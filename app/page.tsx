...
export default function Home({ initialTarget }: { initialTarget?: string }) {
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="heroGlow" /><div className="wrap heroGrid"><div className="heroCopy"><p className="eyebrow">{segment.area} × {segment.industry}の業務改善</p><h1 className="heroTitle"><span>困っている仕事を話すだけ。</span><span>次に仕組み化すべき仕事が見えてくる。</span></h1><p className="lead">AIと人が、最初に整える業務・費用の目安・画面イメージまで無料で整理します。</p><div className="trust"><span>相談無料</span><span>入力は約3分</span><span>しつこい営業なし</span></div><p className="micro">何を作るか決まっていなくても、相談できます。</p></div><div className="googleEmbed" id="contact"><iframe title="無料相談フォーム" src={GOOGLE_FORM_EMBED_URL} loading="lazy" scrolling="yes" frameBorder="0">読み込んでいます…</iframe></div></div></section>
